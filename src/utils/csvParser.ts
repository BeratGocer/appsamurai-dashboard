...
export function testAdNetworkDecoding(): void {
  ...
  const testCases = [
    ...
    // Yeni eklenen test kodları
    'OWNmZDNjZDA3ZWYxNDEyZTkyOGF8', 'Y2MzMGVkNzQtOTUyNC00ODNkLWE5MTItNGQyNjQ3ODg3NDk0', 'MTIxMjc3', 'MTIxNzY4', 'MTM1Mzcy', 'MTIzNzg4', 'NHk5Z01ONldCUTh5', 'MTEwMjI2', 'MTI0MTYx', 'MTIyMTAw', 'MTIyODM3', 'MTIzMTcx', 'MTM1Mzg0', 'MTM1NzMw', 'NGU3MjE3NWUyMDIY0NDhYmJYjd8', 'MTM1ODg0', 'ZTY2YWY2NGNjNGJjNGI2NDk0YjN8', 'MTIzNDQ0', 'MTIyNjgz', 'YmFINDNkM2JkNDI0NDc0NDhmZGJ8', 'MTM3OTgw', 'MTIzMTAx', 'MTM3ODky', 'OTgyODZiNjJjOGZiNDAwOGFmMDI8', 'MTIzNzc0', 'MTM3NzA4', 'ODU0OGM3ZjNiNmQ4NGU4NzliNjI8', 'MmExODZiYzM5Y2Q4NDRiYjhmNzB8', 'ZmM1MmJiNzA5ZjNiNDA3Y2IyMWJ8', 'Mzk0M19FOTNpXzJjZTRCc01TRGl8', 'YXBwa2FybWF8', 'M2dtYTJVWHF1cVhv', 'SC01MkJnTGM3aXZr', 'NjYw', 'ZTZhODEwNTBiMTUxNDhlZjk5ZTl8', 'ODEz', 'MTAxNzY4', 'ODE1', 'MzI5',
