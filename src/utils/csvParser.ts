...
export function testAdNetworkDecoding(): void {
  ...
  const testCases = [
    ...
    'ScR_OTlwSkZrSHNEcm01', 'MTkwMzZ8', 'SPE_WUpaY0xnb1A3QWNh', 'SDA_MXx8', 'SDA_QnN5MFBRaktvS1dq', 'SDA_MjQyM3x8', 'SAP_LV9UVnNKZTY4WjZW', 'SDA_ODk5N3x8', 'SDA_OTA3OHx8', 'SDA_OTAzMHx8',
